...
test("it is a world of its own, on the wire and on the screen", () => {
  ...
  // v1..v4 are still routed; something later is what a new level is drawn
  // under. Nothing ever leaves -- a link that pinned the drowning builds still
  // finds them.
  ...
  expect(knownBuilds()).toContain("swim/4");
