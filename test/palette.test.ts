...
const EXPECTED: Readonly<Record<string, readonly string[]>> = {
  ...
  garden: ["clear", "hedge", "start", "door", "flowers", "bear", "bunny", "squirrel", "bridge", "pond", "box: flower", "box: bear"],
  beach: ["clear", "dune", "start", "sea chest", "shells", "crab", "gull", "jellyfish", "jetty", "sea", "box: shell", "box: crab"],
  city: ["clear", "building", "start", "evac zone", "people", "kaiju", "swarmer", "crawler", "fire", "box: people", "box: kaiju"],
  ...
  space: ["clear", "hull", "start", "airlock", "cores", "robot", "drone", "blob", "acid pool", "box: core", "box: robot"],
};
