...
const swim = (seed: string) => `hoppa/1 swim seed=${seed} tiles=0 behaviour=6`;
const calm = (seed: string) => `hoppa/1 calm seed=${seed} tiles=0 behaviour=5`;
// The beach is the garden's engine drawn somewhere else: same rules, tiles=5.
// See FIRST_SKIN in src/core/tileset.ts.
const beach = (seed: string) => `hoppa/1 calm seed=${seed} tiles=5 behaviour=5`;
