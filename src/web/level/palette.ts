...
export const TOOLS: readonly Tool[] = [
  ...
  { glyph: GLYPH_BOX_TREASURE, label: "box: gem", names: { garden: "box: flower", beach: "box: shell", city: "box: people", jungle: "box: fruit", pyramid: "box: amulet", space: "box: core" }, engines: ["dash", "roam", "calm", "swim"], limit: 6 },
  { glyph: GLYPH_BOX_ENEMY, label: "box: monster", names: { reef: "box: shark", garden: "box: bear", beach: "box: crab", city: "box: kaiju", jungle: "box: jaguar", pyramid: "box: mummy", space: "box: robot" }, engines: ["dash", "roam", "calm", "swim"], limit: 6 },
];
