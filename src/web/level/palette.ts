...
export const TOOLS: readonly Tool[] = [
  ...
  { glyph: GLYPH_WALL, label: "wall", names: { reef: "rock", garden: "hedge", beach: "dune", city: "building", jungle: "trees", pyramid: "blocks", space: "hull" } },
  ...
  // "flag", in every world that flies one -- which is now all of them but the
  // reef and the city. The exit stopped being a door the day it became a flag
  ...
  { glyph: GLYPH_GUARD, label: "goblin", names: { reef: "shark", garden: "bear", beach: "crab", city: "kaiju", jungle: "jaguar", pyramid: "mummy", space: "robot" }, limit: 10 },
  { glyph: GLYPH_BAT, label: "bat", names: { reef: "kraken", garden: "bunny", beach: "gull", city: "swarmer", jungle: "frog", pyramid: "scarab", space: "drone" }, limit: 10 },
  { glyph: GLYPH_DRAGON, label: "lizard", names: { reef: "squid", garden: "squirrel", beach: "jellyfish", city: "crawler", jungle: "monkey", pyramid: "jackal", space: "blob" }, limit: 10 },
  { glyph: GLYPH_LADDER, label: "ladder", names: { garden: "bridge", beach: "jetty", jungle: "log", space: "ladder" }, engines: ["dash", "calm"] },
  ...
  { glyph: GLYPH_BOX_TREASURE, label: "box: gem", names: { garden: "box: flower", beach: "box: shell", city: "box: people", jungle: "box: fruit", pyramid: "box: amulet", space: "box: core" }, engines: ["dash", "roam", "calm", "swim", "raze"], limit: 6 },
  { glyph: GLYPH_BOX_ENEMY, label: "box: monster", names: { reef: "box: shark", garden: "box: bear", beach: "box: crab", city: "box: kaiju", jungle: "box: jaguar", pyramid: "box: mummy", space: "box: robot" }, engines: ["dash", "roam", "calm", "swim", "raze"], limit: 6 },
];
...
export const GAMES = [
  ...
  // The jungle: the garden's game under a canopy. Asked for alongside the
  // pyramid and the space station as "3 other level kinds".
  //
  // The garden's rules fit it without a line of change -- one thing that
  // chases you, two that do not, water to walk round and something across it
  // -- so what makes it a different place to be is the light and the cast. A
