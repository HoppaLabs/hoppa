// Dash, behaviour version 5. Side-on, real time.
//
// v5 changes one thing: pressing up or down while you are touching a ladder
// puts you ON it, centred, instead of leaving you wherever you happened to
// stop.
//
// A body is 192 subcells across and a cell is 256, so a ladder that comes up
// through a one-cell gap in a floor only admits you within 32 subcells of the
// column's centre -- a window 64 wide out of 256. Walking moves you 40 or more
// in a single tick. So a player running at a ladder steps straight over the
// window as often as into it, climbs, jams their shoulders under the floor,
// and slides back down. Reported as "aligning on the stairs is difficult,
// often overshooting or undershooting", which is exactly what it is.
//
// Grabbing the ladder centres you on it: the same answer Donkey Kong, Lode
// Runner and Prince of Persia give, and it costs one assignment. See
// docs/adr/0031.
//
...
export const DASH_V5_BEHAVIOUR = 5;
...
export class DashV5 implements Engine {
  readonly id = "dash" as const;
  readonly behaviourVersion = DASH_V5_BEHAVIOUR;
