...
export const PACK: readonly PackLevel[] = [
  {
    ...
    code: "ESKAAAOpJwekOkOkOk4OGiDhog4PpDpDIgQMOkOlBohYjZGiIiKifrLcesBA",
  },
  {
    slug: "the-long-way",
    name: "the long way",
    teaches: "a room can double back — the gems are not all on your way",
    code: "ESKAAAaW-wekOkOkOkOlpBxAWkOkOkOkOlBlkYlhJaLieaC_",
  },
  {
    slug: "four-corners",
    name: "four corners",
    teaches: "plan a loop rather than chasing the nearest gem",
    code: "ESKAAAmEzwekYKECCgoQIKChAgek4MCBAgwIECDAgFpKCAoSIICgulBolYmRDSFqbSdqJdW7kw",
  },
  {
    slug: "up-and-over",
    name: "up and over",
    teaches: "from the side: ladders go up, and gravity does the rest",
    code: "ETKAAAxyo______-f-Thw5IhJeRZEF6Volyoav6QcQcQcQcQcQcgyA",
  },
  {
    slug: "the-tall-room",
    name: "the tall room",
    teaches: "three floors, and the ladders are never above one another",
    code: "ETKAAA9gd______-f8MkCfAmFF8D5GkQOhMaailKZmzwhxBxBxBAhghAhxBxBxBSgGg",
  },
  {
    slug: "the-gauntlet",
    name: "the gauntlet",
    teaches: "pick the doorway that is not being walked through",
    code: "ESKAABJOSwekQQIOBhAg4GECDgWkwQIYIQIYIQIPpIECCAwQIIB6UGiUiaEPIVI9p2oqVcMa",
  },
  {
    slug: "the-hot-floor",
    name: "the hot floor",
    teaches: "the short way is on fire; the long way is not",
    code: "ESKAABU8HwekOkOkOkOkOkgMDAekOkOkOkOlBthYjhGSIqfaKMKUKcKkKsK0VkWk6Q",
  },
  {
    slug: "the-narrow-way",
    name: "the narrow way",
    teaches: "a guard you can wait out, a fire you cannot",
    code: "ESKAABgp8wekYMDAwMDAwMDAmkwOCA4OCA4OCAWkgOCA4OCAmlBqlYmZDSFqbSdqJdKcW8fssA",
  },
  {
    slug: "mind-the-spikes",
    name: "mind the spikes",
    teaches: "walk through for a heart, or go round the long way",
    code: "ETKAABsXx______-f-RgwmCfY-SJEF8Velwl6pQpZJbN6QcQcQcQcQcQUoDc",
  },
  {
    slug: "the-reef",
    name: "the reef",
    teaches: "strength beats a current, speed goes round the long way",
    code: "EUGAAFIDM______-fkGkOkOkOkOlBEukOkOkOkOkOlBoDQjpGaLimKk0k8lsKuZozpoDRmBL",
  },
  {
    slug: "the-tall-rocks",
    name: "the tall rocks",
    teaches: "weave between the stacks; a current across pushes you off",
    code: "EUGAAE7QEAAAAQAAAwAAAwAAAwAEAwgEAwgEQwiEQwiEQwiEQwiEQwiEQwiEQ____pDQIpEaaCb6jqlUlcmEMNkbo4SuFgLIrw",
  },
  {
    slug: "the-wreck",
    name: "the wreck",
    teaches: "down into the hold, and strength is what gets you back out",
    code: "EUGAAF1J0______-fkGkOkOkOkOCDjgg4kAkLkJBogQkGiBCQaIEOkOlBoDQIpQKgqhSi6k8lEGz9z7_wCc",
  },
  {
    slug: "the-garden",
    name: "the garden",
    teaches: "pick the flowers, mind the bear, keep out of the ponds",
    code: "EVFAACMl8wekPCBgAyQEMiFCOkMEAgA6Q6Q0ISIgciZCBgHCOlB1GQmpIaLKOiWSiqjKjSjiOeTtaLkdk2SkSsS0YkYsY01pJ9kAig",
  },
  {
    slug: "the-beach",
    name: "the beach",
    teaches: "pick the shells up, mind the crab, keep out of the sea",
    code: "EVFUACA4HwekMCFiPCgiKOBAIiBA4EAiIEDiAiIiA8I6Q2QAOkOkOlB0DQFxRSSqcieagCh6jiHNN1gbi-icislMlUlclsl035hxBxBSAF4",
  },
  {
    slug: "the-city",
    name: "the city",
